...
{ for(size_t i = 0; i != m_nodes.size(); i++) m_nodes[i].resetVisitedFlag(); }
...
void Graph::clearNodes() { m_nodes.clear(); }  
...
//trim code taken from: http://stackoverflow.com/questions/1798112/removing-leading-and-trailing-spaces-from-a-string
